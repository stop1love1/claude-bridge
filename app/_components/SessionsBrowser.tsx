      ...
      {deleteMode && onBulkDelete && (
        <div className="px-2 py-1.5 border-b border-border bg-destructive/5 flex items-center gap-2 text-xs sticky top-[88px] z-10">
          ...
          <button
            ...
            className="ml-auto inline-flex items-center justify-center h-6 w-6 rounded border border-destructive/40 text-destructive hover:bg-destructive/10 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-transparent"
          ...
          <button
            ...
            className="inline-flex items-center justify-center h-6 w-6 rounded border border-border text-muted-foreground hover:bg-accent"
            title="Cancel"
